...
**Columbia University, Department of Epidemiology, Causal Inference (CI-NYC) Research Team **, New York, NY (July 2023 – Present) <br>
*Data Analyst* <br>
• Supporting [Dr. Kara Rudolph's](https://www.publichealth.columbia.edu/profile/kara-rudolph-phd) research efforts to understand the mechanisms placing low-income, disabled adults at higher risk of opioid overdose and identify opportunities for improved pain management and risk mitigation. <br>
• Employing rigorous mediation analysis methods to identify key pathways influencing opioid use disorder and ultimately inform points for intervention to reduce risk. <br>
• Leveraging extensive Medicaid data and R programming within an AWS server environment to perform data manipulation and advanced statistical analysis for causal inference epidemiological research. <br>
